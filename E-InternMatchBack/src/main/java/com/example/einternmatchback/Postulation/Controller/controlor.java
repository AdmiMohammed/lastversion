...
public class controlor {
    ...
    public String selection(@PathVariable("StudentID") Integer studentId,
        ...
        /*String prompt = """
                Tu es un assistant IA. Compare les compétences et expériences de l'étudiant avec celles requises pour une offre.
                Retourne les compétences et expériences classées, n'eliminait aucune de ces derniers, dans l'ordre d'importance, sous ce format exact JSON, sans aucune explication ni balises Markdown :
                ...
                Voici les compétences de l'étudiant : %s
                Voici les expériences de l'étudiant : %s
                Voici les compétences requises par l'offre : %s
