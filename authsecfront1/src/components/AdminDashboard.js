...
const AdminDashboard = () => {
    ...
    const fetchDashboardStats = async () => {
        try {
            ...
            // Normalize data to match CompanyDashboard structure
            const normalizedData = {
                userStats: response.data.userStats || {},
                companyStats: response.data.companyStats || {},
                offerStats: response.data.offerStats || {},
        ...
        },
        {
            ...
            chart: stats.offerStats ? (
                ...
                >
                    ...
                    <Legend />
                    <Bar dataKey="value" name="Offres" radius={[4, 4, 0, 0]} fill="#4e79a7" />
                </BarChart>
